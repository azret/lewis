    ...
    public class Xml {
            ...
            switch (c) {
                case '<': {
                        ...
                        if (pos < len && char.IsLetter(buffer[pos])) {
                            ...
                            data = buffer.Substring(attrStart, pos - attrStart);
                ...
                default: {
                        ...
                        data = buffer.Substring(start, pos - start);
                    }
                    break;
            }
        }
        ...
        public void parse(XmlNode parent) {
            ...
            while (token == XmlTokenType.Start) {
                XmlNode child = new XmlNode(XmlNodeType.Element, this.Node, this.Data);
                if (parent != null) {
                    parent.Add(child);
                }
                ...
                while (token == XmlTokenType.Text
                    ...
                    if (token == XmlTokenType.Text) {
                        child.Add(new XmlNode(XmlNodeType.Text, "#TEXT", praseText(this.Data)));
                    }
